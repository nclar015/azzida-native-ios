//
//  MyListHomeViewController.swift
//  Azzida
//
...
class MyListHomeViewController: UIViewController,CarbonTabSwipeNavigationDelegate {
    ...
    override func viewDidLoad() {
        ...
        userModel.UserMainActivity = "MyListHomeViewController"
    ...
    @objc func setText(){
        //  self.title = "My_Listing".localized()
      //  itemslist = ["OFFERED".localized(), "PENDING".localized(), "ACTIVE".localized(),"COMPLETED".localized()]
    ...
    func style() {
        ...
        //carbonTabSwipeNavigation.setNormalColor(UIColor.white.withAlphaComponent(0.7), font: UIFont.boldSystemFont(ofSize: 13))
