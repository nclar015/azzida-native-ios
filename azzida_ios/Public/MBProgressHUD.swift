...
func MB_TEXTSIZE(_ text: String?, font: UIFont) -> CGSize {
    ...
    return textTemp.size(withAttributes: [kCTFontAttributeName as NSAttributedString.Key: font])
}
...
func MB_MULTILINE_TEXTSIZE(_ text: String?, font: UIFont, maxSize: CGSize, mode: NSLineBreakMode) -> CGSize {
    ...
    return textTemp.boundingRect(with: maxSize, options: NSStringDrawingOptions.usesLineFragmentOrigin, attributes: [kCTFontAttributeName as NSAttributedString.Key: font], context: nil).size
}
...
//        }
    ...
    fileprivate func handleGraceTimer(_ theTimer: Timer) {
    ...
    fileprivate func handleMinShowTimer(_ theTimer: Timer) {
        self.hideUsingAnimation(useAnimation)
    }
    ...
    fileprivate func hideUsingAnimation(_ animated: Bool) {
        ...
        if animated && showStarted != nil {
            ...
            UIView.setAnimationDidStop(#selector(MBProgressHUD.animationFinished(_:finished:context:)))
...
//        isFinished = true
    ...
    func showWhileExecuting(_ closures: @escaping MBProgressHUDExecutionClosures, animated: Bool) {
        ...
        Thread.detachNewThreadSelector(#selector(MBProgressHUD.launchExecution), toTarget: self, with: nil)
...
//        }
    ...
    fileprivate func statusBarOrientationDidChange(_ notification: Notification) {
    ...
    override func draw(_ rect: CGRect) {
        ...
        context.addArc(center: CGPoint(x: CGFloat(boxRect.maxX - CGFloat(radius)), y: CGFloat(boxRect.minY + CGFloat(radius))), radius: CGFloat(CGFloat(radius)), startAngle: CGFloat(3 * CGFloat.pi / 2), endAngle: CGFloat(0), clockwise: false)

        context.addArc(center: CGPoint(x: CGFloat(boxRect.maxX - CGFloat(radius)), y: CGFloat(boxRect.maxY - CGFloat(radius))), radius: CGFloat(CGFloat(radius)), startAngle: CGFloat(0), endAngle: CGFloat(CGFloat.pi / 2), clockwise: false)
        context.addArc(center: CGPoint(x: CGFloat(boxRect.minX + CGFloat(radius)), y: CGFloat(boxRect.maxY - CGFloat(radius))), radius: CGFloat(CGFloat(radius)), startAngle: CGFloat(CGFloat.pi / 2), endAngle: .pi, clockwise: false)

        context.addArc(center: CGPoint(x: CGFloat(boxRect.minX + CGFloat(radius)), y: CGFloat(boxRect.minY + CGFloat(radius))), radius: CGFloat(CGFloat(radius)), startAngle: .pi, endAngle: CGFloat(3 * CGFloat.pi / 2), clockwise: false)
...
class MBRoundProgressView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        if annular {
            ...
            context.addArc(center: CGPoint(x: CGFloat(center.x), y: CGFloat(center.y)), radius: CGFloat(radius), startAngle: CGFloat(startAngle), endAngle: CGFloat(endAngle), clockwise: false)
...
class MBBarProgressView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        context.addArc(tangent1End: CGPoint(x: CGFloat(2), y: CGFloat(2)), tangent2End: CGPoint(x: CGFloat(radius + 2), y: CGFloat(2)), radius: CGFloat(radius))

        context.addLine(to: CGPoint(x: rect.size.width - radius - 2, y: 2))
        context.addArc(tangent1End: CGPoint(x: CGFloat(rect.size.width - 2), y: CGFloat(2)), tangent2End: CGPoint(x: CGFloat(rect.size.width - 2), y: CGFloat(rect.size.height / 2)), radius: CGFloat(radius))

        context.addArc(tangent1End: CGPoint(x: CGFloat(rect.size.width - 2), y: CGFloat(rect.size.height - 2)), tangent2End: CGPoint(x: CGFloat(rect.size.width - radius - 2), y: CGFloat(rect.size.height - 2)), radius: CGFloat(radius))

        context.addLine(to: CGPoint(x: radius + 2, y: rect.size.height - 2))
        context.addArc(tangent1End: CGPoint(x: CGFloat(2), y: CGFloat(rect.size.height - 2)), tangent2End: CGPoint(x: CGFloat(2), y: CGFloat(rect.size.height / 2)), radius: CGFloat(radius))
        ...
        if amount >= radius + 4 && amount <= (rect.size.width - radius - 4) {
            ...
            context.addArc(tangent1End: CGPoint(x: CGFloat(4), y: CGFloat(4)), tangent2End: CGPoint(x: CGFloat(radius + 4), y: CGFloat(4)), radius: CGFloat(radius))

            context.addLine(to: CGPoint(x: amount, y: 4))
            context.addLine(to: CGPoint(x: amount, y: radius + 4))
            
            context.move(to: CGPoint(x: 4, y: rect.size.height / 2))
            context.addArc(tangent1End: CGPoint(x: CGFloat(4), y: CGFloat(rect.size.height - 4)), tangent2End: CGPoint(x: CGFloat(radius + 4), y: CGFloat(rect.size.height - 4)), radius: CGFloat(radius))
            ...
            context.addArc(center: CGPoint(x: CGFloat(rect.size.width - radius - 4), y: CGFloat(rect.size.height / 2)), radius: CGFloat(radius), startAngle:.pi, endAngle: CGFloat(angle), clockwise: false)
            ...
            angle = acos(x/radius)
           if angle.isNaN {   angle = 0   }
            context.addArc(center: CGPoint(x: CGFloat(rect.size.width - radius - 4), y: CGFloat(rect.size.height / 2)), radius: CGFloat(radius), startAngle: .pi, endAngle: CGFloat(angle), clockwise: true)
